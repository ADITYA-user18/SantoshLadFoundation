...
export function defaultParams() {
  return {
    ...
    loaderChase: 0.5,
    loaderBottom: 1, // vh
    loaderOut: 0.2, // seconds to fade once the hold lets go
    ...
    snapTime: 0.4, // run-in, once the flick itself is spent
    snapFrom: 1, // rad/s under which the ring commits to a slot
    pickTime: 0.35, // click-to-centre: seconds for one slot, root-scaled
    ...
    metaGapL: 2.2,
    metaGapR: 3.6,
    metaWidth: 25, // this box is the filter region
    ...
    nameMorphTime: 0.35,
    nameEase: "power2.out",
    nameBlur: 3.5, // px the outgoing word smears to before it lets go
    ...
    tagFrom: 99999, // viewport width it needs; below that there is no cursor
    tagText: "",
    tagSize: 14,
    tagWeight: 500,
